...
const signalMessages = [
  { type: '',     text: 'Evento Corporativo F — briefing recebido' },
  { type: 'hot',  text: 'Evento Corporativo G — aguardando aprovação' },
  { type: '',     text: 'Evento Corporativo H — fornecedores confirmados' },
  { type: 'warn', text: 'Evento Corporativo I — prazo de resposta hoje' },
  { type: '',     text: 'Evento Corporativo J — proposta enviada' },
  { type: '',     text: 'Evento Corporativo K — relatório finalizado' },
  { type: 'hot',  text: 'Evento Corporativo L — aguardando aprovação' },
  { type: '',     text: 'Evento Corporativo M — fornecedores confirmados' },
];
let sigIdx = 0;
...
const howSteps = [
  { num: '01', label: 'Passo 1 de 4', title: 'Conte os detalhes do seu evento' },
  { num: '02', label: 'Passo 2 de 4', title: 'Receba a proposta em até 24h' },
  { num: '03', label: 'Passo 3 de 4', title: 'Você aprova e a gente executa' },
  { num: '04', label: 'Passo 4 de 4', title: 'Receba o relatório pós-evento' },
];
